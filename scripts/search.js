...
if (userSettings) pageSize = userSettings.pageSize
// const pageSize = 10
...
const loadPage = async function (page, keyword) {
  ...
  const res = await fetch(
    `https://newsapi.org/v2/everything?q=${keyword}&pageSize=${pageSize}&page=${page}&apiKey=21d1a24d82bb49c7b302a6f9201785cb`
  )
  ...
  try {
    ...
    if (data && data.articles) {
      ...
      newElErr.textContent = 'Chưa có bài viết, vui lòng tìm kiếm'
...
// Chạy hàm loadPage khi mới vào web
;(() => {
  loadPage(page, '')
})()
